                ...
                <div className="container text-Left align-items-center" style={divstyle}>
                    ...
                    <div className="row" style={divstyle}>
                        ...
                        <div className="container border">
                            <div className="row">
                                <div className="col-lg-3 col-md-6 text-center border-end" data-aos="fade-up">
                                ...
                                <div className="col-lg-3 col-md-6 text-center border-end" data-aos="fade-up" data-aos-delay="200">
                                    <div className="count-box">
                                ...
                                <div className="col-lg-3 col-md-6 text-center border-end" data-aos="fade-up" data-aos-delay="400">
                                    <div className="count-box">
                                ...
                                <div className="col-lg-3 col-md-6 text-center border-end" data-aos="fade-up" data-aos-delay="600">
                                    <div className="count-box">
